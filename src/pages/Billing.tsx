...
export default function Billing() {
    ...
    if (appointment) {
      ...
      setEditValues({
        [appointmentId]: {
          ...
          paymentMethod: appointment.paymentMethod || 'Carte Bancaire',
  ...
  const paidAppointments = useMemo(() => {
    return appointments
      .filter(apt => {
        // Only show appointments that have been validated in the dashboard
        return apt.status === 'Validé' && apt.patientId && apt.ficheNumber;
      })
      .map(apt => {
